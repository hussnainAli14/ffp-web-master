...
const links: BreadcrumbsProps[] = [
  { id: '1', name: 'Pending Listings', href: '/dashboard/listings/pending' },
  { id: '2', name: 'Edit Listing', href: '#' },
];

const EditPendingListingPage = () => {
  const {
    handleSubmit,
    onSubmit,
    register,
      ...
      <form onSubmit={handleSubmit(onSubmit)} autoComplete='on' className='flex flex-col gap-4'>
        ...
        <div className='text-sm font-semibold flex justify-between items-center gap-4'>
          <div className='flex justify-start items-center gap-4'>
            <button
              type='button'
              disabled={isLoadingSubmit || isLoadingApprove || isLoadingDelete}
            ...
            {hasAccess(USER_TYPE.ADMIN) && <button
              ...
              className='px-4 py-2 text-primary-btn hover:text-primary-bg'
            >
              {isLoadingApprove ? <LoadingSpinner size='small' /> : 'Approve Listing'}
            </button>}
          </div>
          <div className='flex justify-end items-center gap-4'>
            <Link
              href={(isLoadingSubmit || isLoadingApprove || isLoadingDelete) ? '#' : '/dashboard/listings/pending'}
...
export default EditPendingListingPage;