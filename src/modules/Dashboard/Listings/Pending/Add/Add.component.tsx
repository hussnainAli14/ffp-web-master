...
import { Breadcrumbs, Currency, LoadingSpinner, ReactDropzone, ReactSelect, ReactSwitch, SeparatorLine } from '@ffp-web/components';
...
const links: BreadcrumbsProps[] = [
  ...
  { id: '2', name: 'Add New Listing', href: '#' },
];

const AddPendingListingPage = () => {
  const {
    handleSubmit,
    onSubmit,
    register,
  ...
  return (
    <div className='flex flex-col gap-10'>
      <div className='flex flex-col gap-5'>
        ...
        <div className='text-3xl font-semibold'>Add New Listing</div>
      </div>
...
export default AddPendingListingPage;